...
export default function AddProduct() {
    ...
    return (
        <div>
            <div class="flex overflow-hidden bg-green-600">
                <div >
                    <VendorNavbar />
                            ...
                            <section class="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mt-20">
                                ...
                                <form>
                                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                        ...
                                        <div>
                                            <label class="text-white dark:text-gray-200" for="username">Short Title</label>
                                            <input id="username" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                                        </div>

                                        <div>
                                            <label class="text-white dark:text-gray-200" for="username">Regular Price</label>
                                            <input id="username" type="Number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                                        </div>

                                        <div>
                                            <label class="text-white dark:text-gray-200" for="username">Sales Price</label>
                                            <input id="username" type="Number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-white dark:text-gray-200" for="username">Stock</label>
                                            <input id="username" type="Number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <label class="text-white dark:text-gray-200" for="passwordConfirmation">Visibility</label>
                                            <select class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                        ...
                                        <div>
                                            <button
                                                ...
                                                <span class="ml-2">Click for Warrenty</span>
                                            </button>
                                        </div>
                                        <div>
