...
const IndexLoggedin = () => {
    ...
    const addToCart =async (product_id,sales_price) => {
        const user_id = reduxdata.userInfo.uid;
        const quantity=1;
        const status="pending";
        const price=sales_price;
        const cartItem = { user_id, product_id,quantity,status,price };
